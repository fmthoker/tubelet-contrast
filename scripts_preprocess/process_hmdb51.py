...
def parse_args():
    ...
    parser.add_argument('--raw_dir', default='/ssd/fmthoker/hmdb51/videos/', type=str, help='HMDB-51 data dir')
    parser.add_argument('--ann_dir', default='/ssd/fmthoker/hmdb51/splits/', type=str, help='HMDB-51 split info dir')
    parser.add_argument('--out_dir', default='/ssd/fmthoker/hmdb51/hmdb_ctp', help='output dir')
